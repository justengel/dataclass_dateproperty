...
class date_property(attr_property):
    DOC_FMT = 'date property {}'

    def __init__(self, attr=None, allow_none=True, default: Any = MISSING, default_factory: Callable[[], Any] = MISSING,
                 formats: List[str] = None):
        """Create a date dataclass property.
        ...
        def fset(this, value: typeref):
            if value is None and not allow_none:
                ...
                value = Date.make_date(value, formats=self.formats)
            setattr(this, self.private_name, value)

        self.formats = formats
        super().__init__(attr=attr, fget=fget, fset=fset, fdel=None, default=default, default_factory=default_factory)


class time_property(attr_property):
    DOC_FMT = 'time property {}'

    def __init__(self, attr=None, allow_none=True, default: Any = MISSING, default_factory: Callable[[], Any] = MISSING,
                 formats: List[str] = None):
        """Create a time dataclass property.
...
class datetime_property(attr_property):
    DOC_FMT = 'datetime property {}'
